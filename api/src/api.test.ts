...
describe("populate module", () => {
  describe("unpopulate", () => {
    ...
    it("unpopulates single populated field", async () => {
      ...
      const result = unpopulate(doc as any, "ownerId");
    ...
    it("unpopulates array of populated fields", async () => {
      ...
      const result = unpopulate(doc as any, "items");
    ...
    it("handles nested paths", async () => {
      ...
      const result = unpopulate(doc as any, "nested.items");
    ...
    it("returns original doc when path does not exist", async () => {
      const {unpopulate} = await import("./populate");
      const doc = {name: "test"};
      const result = unpopulate(doc as any, "nonexistent");
    ...
    it("handles nested array paths", async () => {
      ...
      const result = unpopulate(doc as any, "containers.items");
