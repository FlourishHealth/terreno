---
name: submit
description: Deprecated compatibility entry for repository users of `/submit`. Routes verified work to the lifecycle plugin's Brew stage; contains no independent submission implementation.
