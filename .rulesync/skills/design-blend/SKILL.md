---
name: design-blend
description: Build a Terreno implementation from a Claude design file using REST-first backend rules, Terreno-first UI mapping, and mandatory plan-confirm-then-subagent execution.
---
