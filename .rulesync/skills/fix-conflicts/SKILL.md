...
name: fix-conflicts
description: >-
  Integrate the latest base, resolve Terreno conflicts without dropping either side,
  and run affected validation. Lifecycle composition: Brew for PR-update conflicts;
  Taste for current-PR conflicts.
