...
name: buildit
description: >-
  Test-driven implementation — specify behavior as tests first, fulfill one test at a time,
  clean the kitchen between cycles. TypeScript/Bun tooling for the Terreno monorepo.
  Use /buildit when implementing features from a plan or PRD.
---
