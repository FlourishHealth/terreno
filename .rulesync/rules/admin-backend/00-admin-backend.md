...
Admin panel backend plugin for `@terreno/api` that auto-generates admin CRUD
endpoints for Mongoose models. This is a **backend-only** package — no React,
no UI components, no frontend code.
