...
- `2-pick` (before handoff to Roast), `4-brew`, and `/create-pr` when the branch includes frontend paths
- `5-taste` when a fix cycle changes frontend files — re-verify and update PR evidence
