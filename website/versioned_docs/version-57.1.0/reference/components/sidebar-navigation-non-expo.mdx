...
**Story source:** [`demo/stories/Sidebarnavigation(non-expo).stories.tsx`](https://github.com/TerrenoLabs/terreno/blob/master/demo/stories/Sidebarnavigation(non-expo).stories.tsx)
