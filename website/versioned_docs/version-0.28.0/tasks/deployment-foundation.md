...
- [ ] **Task 1.1**: Audit every environment variable in the repo
...
- [ ] **Task 1.2**: Complete `docs/reference/environment-variables.md`
...
- [ ] **Task 1.3**: `[RTK]` Update the `.env.example` files
...
- [ ] **Task 2.1**: Write `docs/explanation/deployment-baseline.md`
...
- [ ] **Task 2.2**: Add the web output-mode decision table
...
- [ ] **Task 2.3**: `[RTK]` Add the multi-environment section
...
- [ ] **Task 3.1**: Verify and fix the backend's port and host binding
...
- [ ] **Task 3.2**: Write the backend Dockerfile
...
- [ ] **Task 3.3**: Add a Docker build CI job
...
- [ ] **Task 3.4**: Reference the Dockerfile from the docs
...
- [ ] **Task 4.1**: `[RTK]` Write `docs/how-to/build-for-web.md`
...
- [ ] **Task 4.2**: Cross-link the deployment documentation
