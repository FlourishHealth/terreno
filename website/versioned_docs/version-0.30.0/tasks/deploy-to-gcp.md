...
- [ ] **Task 1.1**: Write `docs/how-to/deploy-backend-to-cloud-run.md`
...
- [ ] **Task 1.2**: Add the production constraints section
...
- [ ] **Task 1.3**: Write `docs/how-to/deploy-web-to-gcs-cdn.md`
...
- [ ] **Task 1.4**: Write the architecture explainer
...
- [ ] **Task 1.5**: Rewire the existing GCP how-to and index
...
- [ ] **Task 2.3**: Parameterize the GCS hosting script
...
- [ ] **Task 3.2**: Add the troubleshooting reference
...
- [ ] **Task 3.3**: Generate skill mirrors
