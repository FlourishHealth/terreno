...
**Story source:** [`demo/stories/IconButton.stories.tsx`](https://github.com/TerrenoLabs/terreno/blob/master/demo/stories/IconButton.stories.tsx)
...
| `state` | `union` |  | Controls the button's interaction state. Use Default for standard button appearance and Active to indicate a selected or currently engaged state. |
