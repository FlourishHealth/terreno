...
name: pour
description: >-
  Use ONLY when code is ready to enter review and the task is to perform
  commit/push/PR setup plus immediate handoff. Do NOT use for implementation
  work, independent verification, or waiting on CI/comments after the PR is
  open.
---
# Pour
