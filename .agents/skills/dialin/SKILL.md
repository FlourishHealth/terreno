...
name: dialin
description: >-
  Use ONLY when a PR is already open and the task is to run the reactive review
  loop (CI + bot/human comments) until mergeable or timeout. Do NOT use for
  initial planning, feature implementation from scratch, or opening the PR
  itself.
---
# Dial In
