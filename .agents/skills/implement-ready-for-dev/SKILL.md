...
description: >-
  ...
  ⇄ Roast, Brew, then Taste to a mergeable PR. Trigger with
  /implement-ready-for-dev, /autobot-ready-for-dev, Cursor automations, ready
  for dev, implement labeled issues, or pick up ready-for-dev.
---
