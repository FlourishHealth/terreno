import type {SidebarBadgeStatus, SidebarNavigationItem} from "@terreno/ui";
...
export const SidebarNavigationDemo: FC<{
  ...
  const topItems: SidebarNavigationItem[] = [
    ...
    {badge: 5, badgeStatus, iconName: "folder", label: "Projects", route: "projects"},
    {badge: 142, badgeStatus, iconName: "envelope", label: "Messages", route: "messages"},
  ];

  const bottomItems: SidebarNavigationItem[] = [
    {badge: true, badgeStatus, iconName: "gear", label: "Settings", route: "settings"},
