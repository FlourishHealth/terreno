...
Consumers can develop against local copies of Terreno packages using Bun's link feature.
...
# In consumer app workspace
bun link @terreno/ui
```

For complete instructions including Metro config and troubleshooting, see [Link Terreno packages locally](docs/how-to/link-packages-locally.md).
