---
name: roadmap-review
description: Run a Terreno roadmap board hygiene pass — find status drift, stale items, missing labels, and untriaged inbox entries, then report a prioritized set of proposed changes for a maintainer to approve. Trigger with /roadmap-review or phrases like "review the roadmap", "is the board accurate", "roadmap hygiene".
