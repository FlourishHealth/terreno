...
description: >-
  ...
  when `bun run ui:charts:compare` fails, when LineChart/BarChart/AreaChart/DonutChart
  or DashboardGrid paint or layout changes, or when the user asks what changed in
  chart screenshots.
---
