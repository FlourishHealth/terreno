---
name: verify-feature
description: Prove a feature works locally with screenshots and video — web (Chrome/Playwright), native (Maestro), or iOS simulator (EAS dev client). Attach evidence to the PR.
---
