...
description: Upgrade Terreno lockstep @terreno/* packages. Trigger with "upgrade Terreno", "bump @terreno packages", "update to the latest Terreno", or "upgrade terreno version".
---
# Upgrade Terreno
