...
description: 'Resolve and classify Terreno PR comments, plan focused fixes, and implement addressed items without owning submission or CI waiting. Lifecycle composition: Taste.'
