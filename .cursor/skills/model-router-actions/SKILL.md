...
description: Replace app.get/app.post/router.get/router.post application APIs with modelRouter collectionActions and instanceActions. Use when adding or editing Express routes, custom endpoints, OpenAPI handlers, or converting hand-rolled Express methods to Terreno actions.
---
