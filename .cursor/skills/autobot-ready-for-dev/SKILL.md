...
description: 'Unattended Grow → Pick ⇄ Roast → Brew → Taste of one unstarted GitHub issue labeled status:ready-for-dev: claim it, answer Grow questions from the repo and issue unless a genuine human gate, then leave a mergeable PR. Trigger with /autobot-ready-for-dev, autobot ready-for-dev, full-cycle ready-for-dev, or Cursor automations that drain ready-for-dev through Taste.'
---
