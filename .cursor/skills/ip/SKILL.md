---
name: ip
description: 'Terreno repository conventions for implementation plans and task files. Lifecycle composition: Grow. `/ip` is a deprecated compatibility entry that routes planning method to `terreno-1-grow`.'
