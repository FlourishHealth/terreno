...
description: Turn a Claude Code design into small Linear projects with required Implementation Plan and Execution issues, while updating existing projects instead of recreating duplicates.
---
