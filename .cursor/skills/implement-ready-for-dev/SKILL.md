...
description: 'Unattended pickup of one unstarted GitHub issue labeled status:ready-for-dev: claim it, post a Pick plan, Pick ⇄ Roast, then Brew a draft PR. Trigger with /implement-ready-for-dev, Cursor automations, ready for dev, implement labeled issues, or pick up ready-for-dev.'
---
