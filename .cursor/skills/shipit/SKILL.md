---
name: shipit
description: Full PR pipeline — pre-commit checks, commit, push, create/update PR, wait for CI, poll for bot reviews, auto-respond and fix review feedback, resolve addressed threads, and loop until mergeable or blocked. Use /shipit when feature work is ready to ship.
---
# Ship It
