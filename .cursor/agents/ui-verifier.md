---
name: ui-verifier
description: Verify UI changes end to end — compile, lint, UI tests, and Playwright e2e or a running-app smoke test for affected screens. Use after making UI changes in React Native, Expo, or component/story files.
model: inherit
---
