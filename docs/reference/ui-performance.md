...
The benchmarks print machine-readable `UI_P0_BENCHMARK_RESULTS`, `UI_P0_OPENAPI_BENCHMARK_RESULTS`,
`UI_P1_BENCHMARK_RESULTS`, `UI_P2_BUTTON_BENCHMARK_RESULTS`, or
`UI_P2_RESPONSIVE_BOX_BENCHMARK_RESULTS` JSON lines for CI or local reporting.
