...
- [ ] **Task 1.2**: Finish provider types for remaining contracts
...
- [ ] **Task 1.4**: `CommsMessage` attempt history + dashboard fields
...
- [ ] **Task 1.5**: Channel-wide transient retry + no rethrow
...
- [ ] **Task 1.6**: Lifecycle hooks + event intake
