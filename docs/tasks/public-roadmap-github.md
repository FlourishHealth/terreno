...
- [ ] **Task 1.2**: Write the pinned intro posts
...
- [ ] **Task 1.3**: Add Discussion templates
...
- [ ] **Task 2.1**: Document Project board setup
...
- [ ] **Task 2.2**: Write the tracking-issue bodies for this program's IPs
...
- [ ] **Task 3.1**: Define the label set as data
...
- [ ] **Task 3.2**: Add the triage workflow
...
- [ ] **Task 3.3**: Document the backfill triage pass
...
- [ ] **Task 4.1**: Write the roadmap generator
...
- [ ] **Task 4.2**: Add the roadmap workflow
...
- [ ] **Task 4.3**: Seed `ROADMAP.md` and link it
...
- [ ] **Task 4.4**: Add the docs feedback footer link
...
- [ ] **Task 5.1**: Document the Linear bridge rules
...
- [ ] **Task 5.2**: Document the intake flow in `CONTRIBUTING.md`
...
- [ ] **Task 5.3**: Add the release announcement step
