...
Terreno apps use Expo Router with the same file conventions as standard Expo apps. Use
Expo Router's public documentation for dynamic routes, groups, and query parameters.
