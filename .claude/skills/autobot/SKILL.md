...
name: autobot
description: >-
  Deprecated Terreno outer-loop compatibility profile. Routes verified work
  through Brew, then schedules fresh one-iteration Taste invocations from
  structured state until merge-ready or blocked.
