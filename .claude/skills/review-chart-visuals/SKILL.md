...
description: >-
  Review Terreno chart rendered-snapshot diffs with visual intelligence. Trigger
  when `bun run ui:charts:compare` fails, when
  LineChart/BarChart/AreaChart/DonutChart or DashboardGrid paint or layout
  changes, or when the user asks what changed in chart screenshots.
---
