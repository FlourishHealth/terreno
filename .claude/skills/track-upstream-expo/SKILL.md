...
description: >-
  ...
  otherwise create or continue release-X.Y.Z, upgrade Expo, and land native
  fingerprint deps on that branch. Trigger with /track-upstream-expo, "track
  upstream expo", "check expo beta", or "morning expo probe".
