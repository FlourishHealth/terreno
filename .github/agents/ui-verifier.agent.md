...
name: ui-verifier
description: >-
  Verify UI changes end to end — compile, lint, UI tests, launch app, login,
  exercise feature, capture screenshots/videos for the PR. Use after making UI
  changes in React Native, Expo, or component/story files.
tools:
  - agent/runSubagent
---
