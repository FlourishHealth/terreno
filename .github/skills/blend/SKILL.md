...
name: blend
description: >-
  Use ONLY when a concrete spec/Linear ticket/feature request must be converted
  into an Implementation Plan document. Do NOT use for code implementation, PR
  submission, or post-PR review handling.
---
# Blend
