...
Terreno apps use Expo Router. For low-level Expo Router APIs (Link, Stack.Screen, modals, form sheets), see the Expo `building-native-ui` skill. This reference covers Terreno-specific navigation patterns.
