...
description: >-
  Review the current branch diff against Terreno's per-package conventions. Use
  proactively before opening or updating a PR. Read-only; reports findings with
